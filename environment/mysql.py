...
TEMP_FILES = "/home/jinhuijun/CDBTune/train_result/tmp/"
BEST_NOW = "/home/jinhuijun/CDBTune/train_result/"
PROJECT_DIR = "/home/jinhuijun/CDBTune/"
...
class MySQLEnv(object):
    ...
    def step(self, knob):
        ...
        knobs.save_knobs(
            ...
            knob_file='%stuner/save_knobs/knob_metric.txt' % PROJECT_DIR
        )
    ...
    def _get_state(self, knob, method='sysbench'):
        ...
        if method == 'sysbench':
            a = time.time()
            print "bash %sscripts/run_sysbench.sh %s %s %d %s %d %s" % (PROJECT_DIR,
                                                                                   self.wk_type,
                                                                                   self.db_info['host'],
                                                                                   self.db_info['port'],
                                                                                   self.db_info['passwd'],
                                                                                   time_sysbench,
                                                                                   filename)
            os.system("bash %sscripts/run_sysbench.sh %s %s %d %s %d %s" % (PROJECT_DIR,
                                                                                   self.wk_type,
                                                                                   self.db_info['host'],
                                                                                   self.db_info['port'],
                                                                                   self.db_info['passwd'],
            ...
            timer.start()
            os.system('bash %sscripts/run_tpcc.sh %s %d %s %s' % (PROJECT_DIR,
                                                                            self.db_info['host'],
                                                                            self.db_info['port'],
                                                                            self.db_info['passwd'],
                                                                            filename))
...
class Server(MySQLEnv):
    ...
    def initialize(self):
        ...
        print("INTERNAL_METRICS",internal_metrics)
